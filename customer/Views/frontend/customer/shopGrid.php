...
<body>
                        ...
                        <div class="sidebar__item">
                            ...
                            <div class="price-range-wrap">
                                <div class="price-range ui-slider ui-corner-all ui-slider-horizontal ui-widget ui-widget-content" data-min="10" data-max="540">
                                    ...
                                    <span style="background-color: #0E185F;" tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default"></span>
                                    <span style="background-color: #0E185F;" tabindex="0" class="ui-slider-handle ui-corner-all ui-state-default"></span>
                                </div>
                                ...
                                <button class="btn btn-success btn-locgia mt-3">Tìm kiếm theo giá</button>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-5">
                                <div class="filter__sort">
                                    <span>Sort By</span>
                                    <select class="filter__sort__select">
    ...
    <script src="http://localhost/QlBanHang/public/js/customer/shopGrid.js"></script>
</body>
